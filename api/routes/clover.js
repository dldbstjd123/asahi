...
router.get("/email", function (req, res, next) {
    console.log("email")
    let emailStatus = sendEmail("dannydannyl@me.com", "FA554832148" ,"yoon jung")
